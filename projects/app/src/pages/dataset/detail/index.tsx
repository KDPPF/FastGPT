...
import QAPairsPageContextProvider from '@/pageComponents/dataset/detail/QAPairsCard/Context';
...
const QAPairsCard = dynamic(() => import('@/pageComponents/dataset/detail/QAPairsCard/index'));
