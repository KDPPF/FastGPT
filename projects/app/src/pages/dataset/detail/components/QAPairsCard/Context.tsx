...
export const QAPairsPageContext = createContext<QAPairsPageContextType>({
...
const QAPairsPageContextProvider = ({ children }: { children: ReactNode }) => {
  ...
  const contextValue: QAPairsPageContextType = {
  ...
  return <QAPairsPageContext.Provider value={contextValue}>{children}</QAPairsPageContext.Provider>;
};
export default QAPairsPageContextProvider;
